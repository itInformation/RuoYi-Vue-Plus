...
public class CreatorWithdrawLogClientController extends BaseController {
     ...
     * 查询创作者提现记录列表
     */
    @SaCheckPermission("client:withdrawLog:list")
    @GetMapping("/list")
     ...
     * 导出创作者提现记录列表
     */
    @SaCheckPermission("client:withdrawLog:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("client:withdrawLog:query")
    @GetMapping("/{id}")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("client:withdrawLog:remove")
