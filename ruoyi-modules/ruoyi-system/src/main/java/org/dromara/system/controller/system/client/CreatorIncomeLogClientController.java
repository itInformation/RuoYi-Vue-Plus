...
public class CreatorIncomeLogClientController extends BaseController {
     ...
     * 查询创作者收入明细列表
     */
    @SaCheckPermission("client:incomeLog:list")
    @GetMapping("/list")
     ...
     * 导出创作者收入明细列表
     */
    @SaCheckPermission("client:incomeLog:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("client:incomeLog:query")
    @GetMapping("/{id}")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("client:incomeLog:remove")
