...
@RestController
@RequestMapping("/system/diamondLog")
public class UserDiamondLogAdminController extends BaseController {
     ...
     * 查询用户钻石流水列表
     */
    @SaCheckPermission("system:diamondLog:list")
    @GetMapping("/list")
     ...
     * 导出用户钻石流水列表
     */
    @SaCheckPermission("system:diamondLog:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("system:diamondLog:query")
    @GetMapping("/{id}")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("system:diamondLog:remove")
